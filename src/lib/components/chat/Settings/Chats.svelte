<script lang="ts">
	...
	let { saveSettings: _saveSettings }: Props = $props();
	...
	<div class=" space-y-2 overflow-y-scroll max-h-[28rem] lg:max-h-full">
		<div class="flex flex-col">
			...
			>
				...
				<div class=" self-center text-md font-medium">{$i18n.t('Import Chats')}</div>
			</button>
			<button
				class=" flex rounded-md py-2 px-3.5 w-full hover:bg-gray-200 dark:hover:bg-gray-800 transition"
				onclick={() => {
			...
			>
				...
				<div class=" self-center text-md font-medium">{$i18n.t('Export Chats')}</div>
			</button>
		</div>
		...
		<div class="flex flex-col">
			...
			{:else}
				...
				>
					...
					<div class=" self-center text-md font-medium">{$i18n.t('Archive All Chats')}</div>
				</button>
			{/if}
			...
			{:else}
				...
				>
					...
					<div class=" self-center text-md font-medium">{$i18n.t('Delete All Chats')}</div>
				</button>
			{/if}
		</div>
	</div>
