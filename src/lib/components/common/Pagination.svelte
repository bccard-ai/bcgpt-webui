<script lang="ts">
	...
	/**
	 * Pagination — page navigation control built on bits-ui Pagination.
	 *
	 * @example
	 * ```svelte
	 * <Pagination bind:page count={100} perPage={20} />
	 * ```
	 *
	 * @props page - Bindable current page (0-indexed)
	 * @props count - Total item count
	 * @props perPage - Items per page
	 */
	interface Props {
		/** Bindable current page number (0-indexed). */
		page?: number;
