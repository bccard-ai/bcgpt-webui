<script lang="ts">
	...
	interface Props {
		/** Callback fired when the form is submitted with prompt data */
		onSubmit: (data: PromptData) => unknown;
		/** Whether this is editing an existing prompt */
		edit?: boolean;
		/** Existing prompt data for editing */
	...
	let accessControl = $state<unknown>(null);
