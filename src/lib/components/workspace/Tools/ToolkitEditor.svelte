<script lang="ts">
	...
	interface Props {
		/** Whether this is editing an existing toolkit */
		edit?: boolean;
		/** Whether this is cloning an existing toolkit */
		clone?: boolean;
		/** Callback when the toolkit is saved */
		onSave?: (data: unknown) => void;
		/** Toolkit ID */
		id?: string;
		/** Toolkit name */
		name?: string;
		/** Toolkit metadata including description */
	...
	let boilerplate = $state(`import os
import requests
