<script lang="ts">
	 ...
	 * Function Editor
	 *
	 * Full-page code editor for creating/editing a Python function.
	 * Includes name, ID, description fields, CodeEditor with boilerplate,
	 * and save with optional format-then-save flow.
	 */
	...
	interface Props {
		...
		id?: string;
		name?: string;
		meta?: { description: string } & Record<string, unknown>;
		content?: string;
	}
...
from bcgpt.utils.misc import get_last_user_message
...
`;
	...
	/**
	 * Delegate to parent onSave with current form data.
	 */
	...
	/**
	 * Format Python code via the code editor, then save.
	 */
