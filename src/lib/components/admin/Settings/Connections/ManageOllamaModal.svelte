<script lang="ts">
	 ...
	 * Manage Ollama Modal
	 *
	 * Thin modal wrapper around the ManageOllama component.
	 * Provides model management (pull, delete, list) for a specific Ollama connection.
	 */
	...
	interface Props {
		...
		show?: boolean;
		/** Index of the Ollama URL to manage */
		urlIdx?: number | null;
	}
