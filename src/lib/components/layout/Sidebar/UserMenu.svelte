<script lang="ts">
	...
	import { activeUserIds, USAGE_POOL, mobile, showSidebar } from '$lib/stores';
	import Tooltip from '$lib/components/common/Tooltip.svelte';
	import { terminateSession } from '$lib/apis/auths';
	...
	interface Props {
		...
		role?: string;
		/** Additional CSS class names for the dropdown content */
		className?: string;
		/** Snippet for the trigger element */
		children?: import('svelte').Snippet;
		/** Snippet for custom dropdown content (overrides default) */
		content?: import('svelte').Snippet;
		/** Callback invoked when the dropdown state changes */
		onchange?: (...args: unknown[]) => void;
		/** Callback invoked when a show action is triggered */
