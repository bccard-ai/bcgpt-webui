<script lang="ts">
	...
	/** The last word in the search value, used for autocomplete matching */
	...
	/** Filtered search options matching the current last word */
	...
	/** Filtered tags matching the "tag:" prefix search */
	let filteredTags = $derived<{ id: string; name: string }[]>(
